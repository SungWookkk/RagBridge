    ...
    >
      ...
      <button
        ...
        className={cn(
          ...
          toast.variant === "error" && "text-red-300 hover:text-red-50 focus:ring-red-400",
          toast.variant === "warning" && "text-yellow-300 hover:text-yellow-50 focus:ring-yellow-400",
          toast.variant === "success" && "text-green-300 hover:text-green-50 focus:ring-green-400",
          toast.variant === "info" && "text-blue-300 hover:text-blue-50 focus:ring-blue-400"
        )}
        aria-label="토스트 닫기"
      >
        <X className="h-4 w-4" />
