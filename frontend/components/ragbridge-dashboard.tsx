 ...
 */
type PipelineStep = "uploaded" | "ocr_processing" | "field_extraction" | "validation" | "embedding" | "indexing" | "completed" | "error"
...
const sampleDocuments: Document[] = [
  {
    ...
    extractedFields: { "제목": "회사 정책서", "발행일": "2024-01-15", "부서명": "인사팀" },
    validationErrors: [],
            ...
            <Tabs defaultValue="dashboard" value={activeTab} onValueChange={setActiveTab} className="w-full">
              <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <TabsList className="grid w-full max-w-[800px] grid-cols-5 rounded-2xl p-1">
                  ...
                  <TabsTrigger value="documents" className="rounded-xl flex items-center gap-2">
                    <FileCheck className="h-4 w-4" />
                    문서 처리 현황
                  </TabsTrigger>
                  <TabsTrigger value="rag-console" className="rounded-xl flex items-center gap-2">
                    <Brain className="h-4 w-4" />
                    스마트 검색
                  </TabsTrigger>
                  <TabsTrigger value="workspaces" className="rounded-xl flex items-center gap-2">
                    <Layers className="h-4 w-4" />
                    프로젝트
                  </TabsTrigger>
                  <TabsTrigger value="monitoring" className="rounded-xl flex items-center gap-2">
                    <Activity className="h-4 w-4" />
                    실시간 모니터링
                  </TabsTrigger>
                </TabsList>
                <div className="hidden md:flex gap-2">
                  <Button variant="outline" className="rounded-2xl bg-gradient-to-r from-blue-50 to-purple-50 border-blue-200">
                    ...
                    <section className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                        {sampleWorkspaces.map((workspace) => (
                          <motion.div key={workspace.id} whileHover={{ scale: 1.02, y: -5 }} whileTap={{ scale: 0.98 }}>
                  ...
                  <TabsContent value="rag-console" className="space-y-8 mt-0">
                        ...
                        <CardContent>
                          <div className="space-y-3">
                            <div className="p-4 rounded-2xl bg-muted/50">
                              <p className="text-sm text-muted-foreground">검색어를 입력하고 AI 검색을 실행해보세요.</p>
                            </div>
                          </div>
                        </CardContent>
                      </Card>
                    ...
                    <Card className="rounded-3xl">
                      ...
                      <CardContent>
                        <div className="space-y-3">
                          {[
                            { query: "회사 정책서에서 휴가 신청 절차", result: "3개 문서에서 관련 정보 발견", time: "5분 전" },
                            { query: "기술 문서에서 API 사용법", result: "5개 문서에서 관련 정보 발견", time: "1시간 전" },
                            { query: "회의록에서 프로젝트 일정", result: "2개 문서에서 관련 정보 발견", time: "2시간 전" }
                          ].map((item, index) => (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      <Card className="rounded-3xl border-l-4 border-l-green-500">
                        ...
                        <CardContent>
                          ...
                          <p className="text-xs text-muted-foreground">+18% 지난 시간 대비</p>
                        </CardContent>
                      </Card>
                      ...
                      <Card className="rounded-3xl border-l-4 border-l-blue-500">
                        ...
                        <CardContent>
                          ...
                          <p className="text-xs text-muted-foreground">-0.3초 개선</p>
                        </CardContent>
                      </Card>
                      ...
                      <Card className="rounded-3xl border-l-4 border-l-purple-500">
                        ...
                        <CardContent>
                          ...
                          <p className="text-xs text-muted-foreground">+1.2% 향상</p>
                        </CardContent>
                      </Card>
                      ...
                      <Card className="rounded-3xl border-l-4 border-l-orange-500">
                        ...
                        <CardContent>
                          ...
                          <p className="text-xs text-muted-foreground">모든 토픽 정상</p>
                        </CardContent>
                      </Card>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      <Card className="rounded-3xl">
                        ...
                        <CardContent>
                          <div className="space-y-3">
                            {[
                              { topic: "documents.uploaded", status: "정상", lag: 0, throughput: "245/min" },
                              { topic: "documents.parsed", status: "정상", lag: 2, throughput: "198/min" },
                              { topic: "documents.validated", status: "정상", lag: 1, throughput: "186/min" },
                              { topic: "documents.embeddings", status: "정상", lag: 3, throughput: "172/min" }
                            ].map((stream, index) => (
                              <div key={index} className="flex items-center justify-between p-3 rounded-2xl bg-muted/30">
                                ...
                                <div className="text-right">
                                  <p className="text-sm font-medium text-green-600">{stream.status}</p>
