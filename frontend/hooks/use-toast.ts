...
export const showSuccessToast = (
  ...
  console.warn("showSuccessToast는 useToast 훅을 사용하는 컴포넌트 내에서만 호출 가능합니다.")
}
...
export const showErrorToast = (
  ...
  console.warn("showErrorToast는 useToast 훅을 사용하는 컴포넌트 내에서만 호출 가능합니다.")
}
...
export const showWarningToast = (
  ...
  console.warn("showWarningToast는 useToast 훅을 사용하는 컴포넌트 내에서만 호출 가능합니다.")
}
...
export const showInfoToast = (
  ...
  console.warn("showInfoToast는 useToast 훅을 사용하는 컴포넌트 내에서만 호출 가능합니다.")
}
